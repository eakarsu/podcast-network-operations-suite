...
PORT="${PORT:-5800}"
DB_NAME="${PGDATABASE:-podcast_network_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Podcast Network Operations Suite"
echo "======================================="
echo
...
echo "Starting podcast network operations suite frontend on http://localhost:$PORT"
echo "Login: admin@podcast-network-operations.local / admin123"
