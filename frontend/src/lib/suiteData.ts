...
export const sourceSystems = [
  { name: 'AIPodcastNetworkOperationsAssistant', ownership: 'Projects source capabilities and workflows', coverage: ['Projects', 'Assets', 'Calendar'] },
  { name: 'AIPodcastNetworkOperationsOperations', ownership: 'Assets source capabilities and workflows', coverage: ['Scripts', 'Approvals', 'Rights'] },
  { name: 'AIPodcastNetworkOperationsAnalytics', ownership: 'Calendar source capabilities and workflows', coverage: ['Publishing', 'Campaigns', 'Exceptions'] },
  { name: 'AIPodcastNetworkOperationsWorkflow', ownership: 'Scripts source capabilities and workflows', coverage: ['Performance', 'Analytics', 'Reports'] },
];
